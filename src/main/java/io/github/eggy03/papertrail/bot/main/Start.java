...
import io.github.eggy03.papertrail.bot.listeners.audit.event.AuditLogEventListener;
import io.github.eggy03.papertrail.bot.listeners.audit.setup.AuditLogSetupCommandListener;
import io.github.eggy03.papertrail.bot.listeners.message.event.MessageLogListener;
import io.github.eggy03.papertrail.bot.listeners.message.setup.MessageLogSetupCommandListener;
...
import io.github.eggy03.papertrail.bot.listeners.supplementaryaudit.event.guild.GuildBoostEventListener;
import io.github.eggy03.papertrail.bot.listeners.supplementaryaudit.event.guild.GuildMemberJoinAndLeaveEventListener;
import io.github.eggy03.papertrail.bot.listeners.supplementaryaudit.event.guild.GuildPollEventListener;
import io.github.eggy03.papertrail.bot.listeners.supplementaryaudit.event.guild.GuildVoiceEventListener;
