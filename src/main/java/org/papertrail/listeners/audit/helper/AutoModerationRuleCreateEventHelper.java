    ...
    public static void format (GuildAuditLogEntryCreateEvent event, String channelIdToSendTo) {
        ...
        ale.getChanges().forEach((changeKey, changeValue)-> {
            ...
            switch (changeKey) {
                ...
                case "trigger_type" -> eb.addField("Trigger Type", "╰┈➤"+ TypeResolver.automodTriggerTypeResolver(newValue), false);

                case "event_type" -> eb.addField("Event Type", "╰┈➤"+TypeResolver.automodEventTypeResolver(newValue), false);
